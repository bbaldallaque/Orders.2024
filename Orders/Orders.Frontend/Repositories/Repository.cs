...
namespace Orders.Frontend.Repositories
{
    public class Repository : IRepository
    {
        ...
        {
            var messasgeJson = JsonSerializer.Serialize(model);
            var messasgeContent = new StringContent(messasgeJson, Encoding.UTF8, "application/json");
            var responseHttp = await _httpClient.PostAsync(url, messasgeContent);
